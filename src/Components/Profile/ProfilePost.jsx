 ...
 const { isOpen, onOpen, onClose } = useDisclosure()
  ...
  return (
   <>
    ...
    <Flex opacity={0} _hover={{opacity:1}} position={'absolute'} top={0} left={0} right={0} bottom={0} bg={'blackAlpha.780'} transition={'all 0.3s ease'} zIndex={1} justifyContent={'center'}>
         ...
         <Flex gap={4} w={{base:'90%',sm:'70%',md:'full'}} mx={'auto'}>
          ...
          <Flex flex={1} flexDir={'column'} px={10} display={{base:'none',md:'flex'}}>
           ...
           <VStack w={'full'} alignItems={'start'} maxH={'350px'} overflow={'auto'}>
            ...
            <Comment createdAt='12h ago' username='abrahmov' profilePic='https://bit.ly/dan-abramov' text={'Dummy images from unsplash'} />
            <Comment createdAt='2h ago' username='kentdodds' profilePic='https://bit.ly/kent-c-dodds' text={'Dummy images from unsplash'} />
           </VStack>
